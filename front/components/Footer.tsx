        ...
        <footer className="border-t border-gray-700/50 bg-gray-900/80 backdrop-blur-sm mt-auto">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="md:col-span-1">
                        ...
                        <p className="text-gray-400 text-sm">
                            Build your dream PC with our intuitive configurator. Choose from premium components and create the perfect machine.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link href="/builds" className="text-gray-400 hover:text-white transition-colors text-sm">
                                    My Builds
                                </Link>
                            </li>
                            <li>
                                <Link href="/pc/create" className="text-gray-400 hover:text-white transition-colors text-sm">
                                    Build a PC
                                </Link>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="flex items-center gap-3 text-gray-400 text-sm">
                                ...
                                <span>support@partcraft.com</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="border-t border-gray-700/50 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-gray-400 text-sm">
                        © 2026 PartCraft. All rights reserved.
                    </p>
